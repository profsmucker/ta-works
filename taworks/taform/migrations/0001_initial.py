# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-10 16:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ta_expectations', models.BooleanField(default=False)),
                ('cv', models.FileField(blank=True, null=True, upload_to='documents/')),
                ('full_ta', models.BooleanField(default=False)),
                ('three_quarter_ta', models.BooleanField(default=False)),
                ('half_ta', models.BooleanField(default=False)),
                ('quarter_ta', models.BooleanField(default=False)),
                ('past_position_one', models.CharField(blank=True, max_length=1000, null=True)),
                ('past_position_two', models.CharField(blank=True, max_length=1000, null=True)),
                ('past_position_three', models.CharField(blank=True, max_length=1000, null=True)),
            ],
        ),
        migrations.AddField(
