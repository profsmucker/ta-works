...
class Course(models.Model):
    ...
    course_subject = models.CharField(null=True, max_length=255)
    course_id = models.CharField(null=True, max_length=255)
    section = models.CharField(null=True, max_length=255)
    course_name = models.CharField(null=True, max_length=255)
